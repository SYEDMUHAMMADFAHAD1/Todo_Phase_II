...
# Test to check if deletion actually affects the test.db database
BASE_URL = "http://localhost:8000"
DB_PATH = r"C:\master_second_copy\Todo_App\backend\test.db"  # Using test.db instead
...
def test_real_deletion_with_correct_db():
    print("Testing real deletion by checking test.db database directly...")
...
if __name__ == "__main__":
    success = test_real_deletion_with_correct_db()
    if success:
